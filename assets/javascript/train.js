...
dbRefObject.on("child_added", snap => {
    ...
    const $nextArrival = $("<td>", { 'class': 'next-arrival editable', text: meridiem(nextTrain) });
...
///////////////////////////////////////////
// hey GT! Below is what I tried to make work I really wanted to have people edit and stuff... 
// but man... that's harder than it looks
// ;D I was able to to get the minutes remaining to update each minute and the next train variable updates!
///////////////////////////////////////////
